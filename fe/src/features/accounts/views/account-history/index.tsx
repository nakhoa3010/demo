...
import { formatDate, formatNumberWithUnit, shortAddress } from '@/lib/utils/format';
              ...
              {accountDetail?.history.map((item, index) => (
                ...
                >
                  ...
                  <td className="p-4">
                    <Typography.Body
                      variant="14_regular"
                      text={formatNumberWithUnit(Number(item.amount))}
                    />
                  </td>
                  <td className="p-4">
                    <Typography.Body
                      variant="14_regular"
                      text={formatNumberWithUnit(Number(item.balance))}
                    />
                  </td>
                </tr>
              ))}
