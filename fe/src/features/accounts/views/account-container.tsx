...
const steps = [
  {
    ...
    contractAddress: '0xc2C88492Cf7e5240C3EB49353539E75336960600',
    icon: '/icons/spin.svg',
  },
  {
...

  {
    ...
    type: 'Coordinator address',
    contractAddress: '0x3F247f70DC083A2907B8E76635986fd09AA80EFb',
    icon: '/icons/spin.svg',
  },
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="flex flex-col items-start justify-between gap-1">
                <Typography.Body variant="16_regular" className="text-white-60" text={step.type} />
