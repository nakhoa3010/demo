...
import { API_URL, DELEGATOR_URL } from './settings.js'
import { buildUrl, idOption, isOraklDelegatorHealthy } from './utils.js'

const AGGREGATOR_ENDPOINT = buildUrl(API_URL, 'aggregator')
...
export function signHandler() {
  async function wrapper({ txData }: { txData }) {
    ...
    try {
      const endpoint = buildUrl(DELEGATOR_URL, `sign`)
...
export function organizationListHandler() {
  async function wrapper() {
    ...
    try {
      const endpoint = buildUrl(DELEGATOR_URL, `organization`)
      const result = (await axios.get(endpoint)).data
      console.log(result)
      return result
    } catch (e) {
...
export function organizationRemoveHandler() {
  async function wrapper({ id }: { id: number }) {
    ...
    try {
      const endpoint = buildUrl(buildUrl(DELEGATOR_URL, `organization`), id.toString())
...
export function reporterListHandler() {
  async function wrapper() {
    ...
    try {
      const endpoint = buildUrl(DELEGATOR_URL, `reporter`)
      const result = (await axios.get(endpoint)).data
...
export function reporterRemoveHandler() {
  async function wrapper({ id }: { id: number }) {
    ...
    try {
      const endpoint = buildUrl(buildUrl(DELEGATOR_URL, `reporter`), id.toString())
      const result = (await axios.delete(endpoint)).data
      console.log(result)
      return result
    } catch (e) {
...
export function contractListHandler() {
  async function wrapper() {
    ...
    try {
      const endpoint = buildUrl(DELEGATOR_URL, `contract`)
      const result = (await axios.get(endpoint)).data
      console.log(result)
      return result
    } catch (e) {
...
export function contractRemoveHandler() {
  async function wrapper({ id }: { id: number }) {
    ...
    try {
      const endpoint = buildUrl(buildUrl(DELEGATOR_URL, `contract`), id.toString())
      const result = (await axios.delete(endpoint)).data
      console.log(result)
      return result
    } catch (e) {
...
export function contractConnectHandler() {
  async function wrapper({ contractId, reporterId }: { contractId: number; reporterId: number }) {
    ...
    try {
      const endpoint = buildUrl(DELEGATOR_URL, `contract/connectReporter`)
...
export function contractDisconnectHandler() {
  async function wrapper({ contractId, reporterId }: { contractId: number; reporterId: number }) {
    ...
    try {
      const endpoint = buildUrl(DELEGATOR_URL, `contract/disconnectReporter`)
      const result = (await axios.post(endpoint, { contractId, reporterId })).data
      console.log(result)
      return result
    } catch (e) {
...
export function functionListHandler() {
  async function wrapper() {
    ...
    try {
      const endpoint = buildUrl(DELEGATOR_URL, `function`)
      const result = (await axios.get(endpoint)).data
      console.log(result)
      return result
    } catch (e) {
...
export function functionRemoveHandler() {
  async function wrapper({ id }: { id: number }) {
    ...
    try {
      const endpoint = buildUrl(buildUrl(DELEGATOR_URL, `function`), id.toString())
      const result = (await axios.delete(endpoint)).data
      console.log(result)
      return result
    } catch (e) {
